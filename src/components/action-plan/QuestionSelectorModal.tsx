...
import { X, ChevronDown, ChevronRight, Search, FileText, CheckCircle, Loader2 } from 'lucide-react';
  ...
  const loadQuestions = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE}/api/v1/campaigns/${campaignId}/questions-with-control-points`,
        {
          headers: {
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-semibold">Sélectionner une question</h3>
              <p className="text-purple-200 text-sm">
                Choisissez la question source pour cette action
              </p>
            </div>
          </div>
          <button
